...
func TestProposalSlashingSignatures(t *testing.T) {
	...
	t.Run("valid proposal", func(t *testing.T) {
		_, err = signer.SignBeaconBlock(&eth.BeaconBlock{
			Slot:          99,
			ProposerIndex: 2,
			ParentRoot:    []byte("Z"),
			StateRoot:     []byte("Z"),
			Body:          &eth.BeaconBlockBody{},
		}, []byte("domain"), _byteArray("95087182937f6982ae99f9b06bd116f463f414513032e33a3d175d9662eddf162101fcf6ca2a9fedaded74b8047c5dcf"))
		require.NoError(t, err)
	})
	...
	t.Run("double proposal, different body root. Should error", func(t *testing.T) {
		_, err = signer.SignBeaconBlock(&eth.BeaconBlock{
			...
			ParentRoot:    []byte("Z"),
			StateRoot:     []byte("Z"),
			Body:          &eth.BeaconBlockBody{Graffiti: []byte("d")},
		}, []byte("domain"), _byteArray("95087182937f6982ae99f9b06bd116f463f414513032e33a3d175d9662eddf162101fcf6ca2a9fedaded74b8047c5dcf"))
		require.NotNil(t, err)
		require.EqualError(t, err, "err, slashable proposal: DoubleProposal")
	})
