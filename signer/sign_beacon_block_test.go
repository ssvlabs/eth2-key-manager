...
func TestBlockProposalAltair(t *testing.T) {
	require.NoError(t, core.InitBLS())
...
func TestBlockProposalBellatrix(t *testing.T) {
	require.NoError(t, core.InitBLS())
...
func TestBlockProposalCapella(t *testing.T) {
	require.NoError(t, core.InitBLS())
...
func TestBlockProposalDeneb(t *testing.T) {
	require.NoError(t, core.InitBLS())
	...
	t.Logf("block SSZ (base64): %s", base64.StdEncoding.EncodeToString(ssz))
